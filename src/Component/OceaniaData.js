...
const OceaniaData = (props) => {
    const oceaniaStatistics = props.statistics.filter((statistic) => statistic.continent == 'Oceania');
    return (
        <div className='continent-details'>
            <React.Fragment className='country-list'>
                {oceaniaStatistics.map((statistic) => (
...
export default APIdata(OceaniaData);
