...
const NorthAmericaData = (props) => {
    const northAmericaStatistics = props.statistics.filter((statistic) => statistic.continent == 'North-America');
    return (
        <div className='continent-details'>
            <React.Fragment className='country-list'>
                {northAmericaStatistics.map((statistic) => (
...
export default APIdata(NorthAmericaData);
