...
const AfricaData = (props) => {
    const africaStatistics = props.statistics.filter((statistic) => statistic.continent == 'Africa');
    return (
        <div className='continent-details'>
            <React.Fragment className='country-list'>
                {africaStatistics.map((statistic) => (
...
export default APIdata(AfricaData);
